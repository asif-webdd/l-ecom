                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                      ...
                      <span class="badge-dot">
                        ...
                        <tr>
                            <td>
                                <img alt="Image placeholder" src="{{ asset('assets/admin/images/products/02.png') }}" class="product-img">
                            </td>
                            <td>Clasic Shoes</td>
                            <td>$1,520 USD</td>
                            <td>
                      <span class="badge-dot">
                        ...
                        <tr>
                            <td>
                                <img alt="Image placeholder" src="{{ asset('assets/admin/images/products/03.png') }}" class="product-img">
                            </td>
                            <td>Hand Watch</td>
                            <td>$1,620 USD</td>
                            <td>
                      <span class="badge-dot">
                        ...
                        <tr>
                            <td>
                                <img alt="Image placeholder" src="{{ asset('assets/admin/images/products/04.png') }}" class="product-img">
                            </td>
                            <td>Hand Camera</td>
                            <td>$2,220 USD</td>
                            <td>
                      <span class="badge-dot">
                        ...
                        <tr>
                            <td>
                                <img alt="Image placeholder" src="{{ asset('assets/admin/images/products/05.png') }}" class="product-img">
                            </td>
                            <td>Iphone-X Pro</td>
                            <td>$9,890 USD</td>
                            <td>
                      <span class="badge-dot">
                        ...
                        <tr>
                            <td>
                                <img alt="Image placeholder" src="{{ asset('assets/admin/images/products/06.png') }}" class="product-img">
                            </td>
                            <td>Ladies Purse</td>
                            <td>$3,420 USD</td>
                            <td>
